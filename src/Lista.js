		...
		this.state = {
			list:[
				...
				},
				{
					...
					por:'Equipe Tudo Gostoso',
					descricao:'Este é um bolo cremoso feito com milho verde.',
					rendimento:16,
					preparo:45,
					imagem:'https://img.itdg.com.br/tdg/images/recipes/000/094/018/317417/317417_original.jpg?mode=crop&width=540&height=400',
					ingredientes:[
						{key:'1', txt:'1 lata de milho verde'},
						{key:'2', txt:'1 lata de óleo (medida da lata de milho)'},
						{key:'3', txt:'1 lata de açúcar (medida da lata de milho)'},
						{key:'4', txt:'1 lata de fubá (medida da lata de milho)'},
						{key:'5', txt:'4 ovos'},
						{key:'6', txt:'1 e 1/2 colher (chá) de fermento em pó'},
					],
					modo:[
						{key:'1', txt:'Em um liquidificador, adicione o milho verde, o óleo, o açúcar, o fubá, os ovos e a farinha de trigo, depois bata até obter uma consistência cremosa.'},
						{key:'2', txt:'Depois, acrescente o coco ralado e o fermento, misture novamente.'},
						{key:'3', txt:'Despeje a massa em uma assadeira untada e leve para assar, em um forno médio a 180 °C, preaquecido por 40 minutos.'},
					]
				},
				{
					key:'761',
					nome:"Strogonof de Carne Simples",
					por:'Equipe Tudo Gostoso',
					descricao:'Este é um bolo cremoso feito com milho verde.',
					rendimento:16,
					preparo:45,
					imagem:'https://img.itdg.com.br/tdg/images/recipes/000/053/915/297758/297758_original.jpg?mode=crop&width=540&height=400',
					ingredientes:[
						{key:'1', txt:'1 lata de milho verde'},
						{key:'2', txt:'1 lata de óleo (medida da lata de milho)'},
						{key:'3', txt:'1 lata de açúcar (medida da lata de milho)'},
